        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="mb-4 col-span-2">
            ...
            <textarea
              ...
              className="block w-full p-2 bg-gray-100 border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 transition duration-150 ease-in-out"
            ></textarea>
            {errors.previousSchool && <p className="text-red-500">{errors.previousSchool.message}</p>}
          </div>
          <div>
            <label htmlFor="grade" className="block text-lg font-medium dark:text-white text-gray-700 mb-2">
              Applying for Grade
            </label>
            <input
              type="text"
